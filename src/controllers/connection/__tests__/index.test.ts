...
describe('ConnectionController', () => {
  ...
  describe('listConnections', () => {
    it('should return rendered list template', async () => {
      ...
      const result = await controller.listConnections(req).then(toHTMLString)
    ...
    it('should call db as expected', async () => {
      ...
      await controller.listConnections(req).then(toHTMLString)
    ...
    it('should call db as expected', async () => {
      ...
      const controller = new ConnectionController(...args)
      const spy: sinon.SinonSpy = sinon.spy(dbMock, 'get')
      await controller.listConnections(req, 'dig').then(toHTMLString)
      const search = 'dig'
  ...
  describe('renderPinCode', () => {
    it('should render form', async () => {
      const { args } = withConnectionMocks(null, null, 'pending')
      const controller = new ConnectionController(...args)
      const result = await controller.renderPinCode(req, validConnection.id, '123456').then(toHTMLString)
  ...
  describe('submitPinCode', () => {
    it('should render error if it is longer than 6 digits', async () => {
      ...
      const result = await controller
        .submitPinCode(req, { action: 'submitPinCode', pin: '123456782' }, validConnection.id)
        .then(toHTMLString)
    ...
    it('also should render error if it combined characters and numbers', async () => {
      ...
      const controller = new ConnectionController(...args)
      const result = await controller
        .submitPinCode(req, { action: 'submitPinCode', pin: '1235235asdasd' }, validConnection.id)
        .then(toHTMLString)
    ...
    it('should accept only numbers', async () => {
      ...
      const controller = new ConnectionController(...args)
      const result = await controller
        .submitPinCode(req, { action: 'submitPinCode', pin: 'not-valid-code' }, validConnection.id)
        .then(toHTMLString)
    ...
    it('renders a success screen', async () => {
      ...
      const controller = new ConnectionController(...args)
      const result = await controller
        .submitPinCode(req, { action: 'submitPinCode', pin: '111111' }, validConnection.id)
        .then(toHTMLString)
    ...
    it('should return a form page', async () => {
      ...
      const controller = new ConnectionController(...args)
      const result = await controller
        .submitPinCode(req, { action: 'submitPinCode', pin: '111112' }, validConnection.id)
        .then(toHTMLString)
