  ...
  describe('/reset ', () => {
    ...
    describe('if DEMO_MODE = true', () => {
      ...
      it('deletes connections and connection_invites locally', () => {
        ...
        expect(cloudagentMock.closeConnection.firstCall.args[1]).to.deep.equal(['00000000-1111-4000-a000-000000001111'])
        expect(cloudagentMock.closeConnection.secondCall.args[1]).to.deep.equal([
          '00000000-1111-4000-a000-000000002222',
        ])
        expect(cloudagentMock.closeConnection.thirdCall.args[1]).to.deep.equal(['00000000-1111-4000-a000-000000003333'])
