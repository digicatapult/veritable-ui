  ...
  describe('listCredentials', () => {
    it('should return rendered list of credentials template', async () => {
      ...
      expect(result).to.equal(
        'listCredentials_issuer-done-DIGITAL CATAPULT-Supplier credential-holder-done-DIGITAL CATAPULT-Supplier credential-issuer-done-CARE ONUS LTD-Supplier credential-holder-done-CARE ONUS LTD-Supplier credentials_listCredentials'
      )
    })
    ...
    it('returns credentials list (alice)', async () => {
      ...
      expect(res).to.equal(
        'listCredentials_issuer-done-CARE ONUS LTD-Supplier credential-holder-done-CARE ONUS LTD-Supplier credentials_listCredentials'
      )
    })
    ...
    it('returns credentials list(bob)', async () => {
      ...
      expect(res).to.equal(
        'listCredentials_issuer-done-DIGITAL CATAPULT-Supplier credential-holder-done-DIGITAL CATAPULT-Supplier credentials_listCredentials'
      )
    })
  })
})
